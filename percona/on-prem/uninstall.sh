...
main() {
    ...
    if [ "$initial_ns_state" = "Terminating" ]; then
        ...
        echo ""
        echo -e "  ${CYAN}1. Force-finalize the namespace immediately${NC}"
        ...
        echo ""
        echo -e "  ${CYAN}2. Clean up resources first, then finalize (RECOMMENDED)${NC}"
        ...
        echo ""
        echo -e "  ${CYAN}3. Cancel and troubleshoot manually${NC}"
