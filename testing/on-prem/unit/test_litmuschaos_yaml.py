...
def test_litmus_operator_template_valid():
    ...
    path = os.path.join(os.getcwd(), '..', '..', 'percona', 'templates', 'litmuschaos', 'litmus-operator.yaml')
...
def test_litmus_admin_clusterrole_template():
    ...
    path = os.path.join(os.getcwd(), '..', '..', 'percona', 'templates', 'litmuschaos', 'litmus-admin-clusterrole.yaml')
    with open(path, 'r', encoding='utf-8') as f:
        cr = yaml.safe_load(f)
...
def test_litmus_admin_clusterrolebinding_template():
    ...
    path = os.path.join(os.getcwd(), '..', '..', 'percona', 'templates', 'litmuschaos', 'litmus-admin-clusterrolebinding.yaml')
    with open(path, 'r', encoding='utf-8') as f:
        content = f.read()
...
def test_pod_delete_chaosexperiment_template():
    ...
    path = os.path.join(os.getcwd(), '..', '..', 'percona', 'templates', 'litmuschaos', 'pod-delete-chaosexperiment.yaml')
    with open(path, 'r', encoding='utf-8') as f:
        content = f.read()
        # Check placeholder exists
